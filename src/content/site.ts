...
import groupPortrait from "../../assets/94-DSC01189.jpg";
import practiceAssist from "../../assets/246-DSC01496.jpg";
import groupClass from "../../assets/SWEARxEspai Adarsha-32.jpg";
import teacherAssist from "../../assets/SWEARxEspai Adarsha-37.jpg";
...
export const contact = {
  ...
  whatsapp: "+34 655 753 256",
  addressShort: "Carrer Girona 166, Entresuelo 3ra Barcelona",
  address: ["Calle Girona 166, ent 3a", "08037 Barcelona"],
};
...
export const homeCopy = {
  ...
  purpose: [
    "Nuestro propósito es ofrecerte un espacio donde puedas reconectarte contigo mismo, descubrir tu fuerza interior y cultivar la calma que tu mente y tu corazón necesitan.",
    "Cada práctica de yoga es una oportunidad para transformar tu cuerpo, equilibrar tus emociones y nutrir tu espíritu con herramientas que te acompañarán en tu día a día.",
    "Empieza hoy este viaje hacia una vida más consciente, saludable y plena.",
    "Transforma tu cuerpo, tu mente y tu energía en Espai Adarsha.",
  ],
  ecosystemTitle: "¿Quieres conocer nuestro ecosistema?",
  ecosystemBody:
    "Sesiones de Movimiento y Conciencia Pélvica para despertar tu pelvis a través de ejercicios diseñados para relajar, flexibilizar y tonificar la musculatura del suelo pélvico.",
  ecosystemFoot:
    "Y si estas buscando casa para tu proyecto y quieres formar parte de nuestro equipo de colaboradores ponte en contacto con nosotros. Espai Adarsha es más que un estudio, es una red de terapeutas independientes!",
};

export const yogaCopy = {
  introTitle: "Practica yoga en Adarsha",
  introQuestion: "¿Estas buscando un estudio de confianza?",
  ...
  closing:
    "Cambiando desde adentro, transformamos lo de fuera. Un espacio diseñado para que el yoga sea el vehículo de vuelta a tu equilibrio.",
  prices: [
    {
  ...
  individualEyebrow: "con Laia Espejo",
  individualBody: [
...
export const espacioCopy = {
  title: "Espai Adarsha",
  subtitle: "Un hogar para tus formaciones y workshops",
  body: [
...
export const colaboradoresCopy = {
  title: "Otras actividades que tienen lugar en Espai Adarsha",
  subtitle: "Conoce nuestro ecosistema de terapeutas",
  activity: "Movimiento & Consciencia Pélvica",
  teacher: "con Raquel Jaroslavsky",
  body: [
    "¿Te sientes desconectada de tu pélvis?",
  ...
  schedule: "Martes 17:45 - 19:00 / Jueves 13:15 - 14:30 / Jueves 17:45 - 19:00",
  booking: "Reserva sesión de prueba: jarosraquel@gmail.com",
  prices: [
